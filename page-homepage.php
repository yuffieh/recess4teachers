...
<div class="container-fluid">
  ...
  <div class="overlay-absolute">
    <div class="section">
      <h2 style="text-align: center">In The Last 5 Years, We've Lost 50% of Our Public School
        Teachers</h2>
      <div class="img-header">
        <img
            src="https://as2.ftcdn.net/jpg/01/92/03/63/1024W_F_192036340_QvWtrdORNCpBfzbByww029NYoWUzDe3U_NW1.jpg">
      </div>
    </div>
    <div class="section-one"
         style="background-position: center; background-image: url('<?php echo get_template_directory_uri(); ?>/imgs/book-work.jpg');">
